...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  // Generamos una ID para cada paciente por medio de la funcion generarId() 
  const generarId = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if ([nombre, propietario, email, fecha, sintomas].includes('')) {
      // console.log('l menos un campo vacio')
      setError(true)
      return;
    }
  ...
  return (
    <div className='md:w-1/2 lg:w-2/5 mx-5'>
      ...
      <form
        ...
        {/* Ternario */}
        {/* Imprimimos el mensaje de error por medio de children */}
